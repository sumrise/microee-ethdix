...
public class ETHSubscribeRestful {
    ...
    public R<Boolean> newHeads(@RequestParam(value = "chainId", required = false, defaultValue = "mainnet") String chainId) {
    ...
    @RequestMapping(value = "/newPendingTransactions", method = RequestMethod.GET,
            produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
    public R<Boolean> newPendingTransactions(@RequestParam(value = "chainId", required = false, defaultValue = "mainnet") String chainId) {
